...
void LC_HousekeepingReq_Test_ActionNotUsedStale(void)
{
    ...
    {
        LC_OperData.ARTPtr[TableIndex].CurrentState = LC_APSTATE_ACTION_NOT_USED;
...
void LC_SetAPStateCmd_Test_SetAllActionPointsActiveOneNotUsed(void)
{
    ...
    LC_OperData.ARTPtr[0].CurrentState = LC_APSTATE_ACTION_NOT_USED;
    ...
    /* Checks for first index: */
    TableIndex = 0;
    UtAssert_True(LC_OperData.ARTPtr[TableIndex].CurrentState == LC_APSTATE_ACTION_NOT_USED,
                  "LC_OperData.ARTPtr[TableIndex].CurrentState == LC_APSTATE_ACTION_NOT_USED");
...
void LC_SetAPStateCmd_Test_UpdateSingleActionPointNotUsed(void)
{
    ...
    LC_OperData.ARTPtr[UT_CmdBuf.SetAPStateCmd.APNumber].CurrentState = LC_APSTATE_ACTION_NOT_USED;

    /* Execute the function being tested */
    LC_SetAPStateCmd(&UT_CmdBuf.Buf);

    /* Verify results */
    UtAssert_True(LC_OperData.ARTPtr[UT_CmdBuf.SetAPStateCmd.APNumber].CurrentState == LC_APSTATE_ACTION_NOT_USED,
                  "LC_OperData.ARTPtr[UT_CmdBuf.SetAPStateCmd.APNumber].CurrentState == LC_APSTATE_ACTION_NOT_USED");
